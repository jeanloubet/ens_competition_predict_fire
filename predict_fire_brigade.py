...
def traitement_x(df):
    #ajust types
    df=df[["floor","longitude intervention","latitude intervention","longitude before departure","latitude before departure","OSRM estimated distance","OSRM estimated duration"]]
